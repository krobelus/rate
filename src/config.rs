...
impl Config {
    ...
    pub fn new(matches: ArgMatches) -> Config {
        ...
        if !drat_trim && !rupee {
            ...
            if rat_first_pivot {
                warn!("Flag --rat-first-pivot overrides the --rat-any-pivot implied by --drat-trim") ;
            } else {
                rat_any_pivot = true ;
            }
            ...
            if text_format {
                ...
                warn!("Flag --binary overrides the --heuristic-binary-detect implied by --drat-trim") ;
        ...
        if Self::check_incompatible(&[text_format , binary_format , drat_trim_format , prefix_format]) {
            incompatible_options("--text , --binary , --heuristic-binary-detect , --prefix-binary-detect");
        }
